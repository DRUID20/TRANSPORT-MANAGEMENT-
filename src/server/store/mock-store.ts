...
// ============================================================
// Notifications (Phase 7): templates, preferences, outbound log
// ============================================================
...
function tplId(category: NotificationCategory, channel: NotificationChannel): string {
  return `tpl-${category}-${channel}`;
}
function prefId(recipientId: string, category: NotificationCategory): string {
  return `pref-${recipientId}-${category}`;
}

interface TemplateSeed {
  category: NotificationCategory;
  email: { subject: string; body: string };
  sms: { body: string };           // SMS subject == first 60 chars of body
...
const TEMPLATE_SEEDS: TemplateSeed[] = [
  {
    category: "trip_planned",
    email: {
      subject: "Trip {{tripNumber}} planned — {{origin}} → {{destination}}",
      body: "Trip {{tripNumber}} has been planned.\n\nRoute: {{origin}} → {{destination}}\nTruck: {{truckPlate}}\nDriver: {{driverName}}\nETA: {{eta}}\n\nOpen the trip: {{href}}",
    },
    sms: { body: "TX: Trip {{tripNumber}} planned {{origin}}>{{destination}}, truck {{truckPlate}}." },
    inApp: { subject: "Trip {{tripNumber}} planned", body: "{{origin}} → {{destination}} on {{truckPlate}}" },
  },
  {
    category: "trip_loaded",
    email: {
      subject: "Trip {{tripNumber}} loaded",
      body: "Trip {{tripNumber}} has been loaded at {{origin}}.\n\nWeighbridge: {{weight}}\nManifest #: {{manifest}}\n\nTrack the trip: {{href}}",
    },
    sms: { body: "TX: Trip {{tripNumber}} loaded at {{origin}}, departing now." },
    inApp: { subject: "Trip {{tripNumber}} loaded", body: "Loaded at {{origin}} — {{weight}}" },
  },
  {
    category: "trip_at_border",
    email: {
      subject: "Trip {{tripNumber}} at {{border}}",
      body: "Trip {{tripNumber}} has arrived at {{border}} and is awaiting clearance.\n\n{{href}}",
    },
    sms: { body: "TX: Trip {{tripNumber}} at {{border}} awaiting clearance." },
    inApp: { subject: "Trip {{tripNumber}} at border", body: "{{border}} — awaiting clearance" },
  },
  {
    category: "trip_delivered",
    email: {
      subject: "Trip {{tripNumber}} delivered",
      body: "Trip {{tripNumber}} has been delivered to {{destination}}.\nPlease ensure POD is uploaded.\n\n{{href}}",
    },
    sms: { body: "TX: Trip {{tripNumber}} delivered at {{destination}}. POD pending." },
    inApp: { subject: "Trip {{tripNumber}} delivered", body: "Delivered at {{destination}}" },
  },
  {
    category: "trip_pod_uploaded",
    email: {
      subject: "POD uploaded for trip {{tripNumber}}",
      body: "Proof of delivery for trip {{tripNumber}} has been uploaded by {{driverName}}.\n\n{{href}}",
    },
    sms: { body: "TX: POD uploaded for trip {{tripNumber}}." },
    inApp: { subject: "POD uploaded", body: "Trip {{tripNumber}} — POD ready" },
  },
  {
    category: "expense_submitted",
    email: {
      subject: "Expense {{number}} submitted by {{employee}}",
      body: "{{employee}} submitted expense {{number}} for {{currency}} {{amount}}.\n\nReason: {{reason}}\n\nApprove: {{href}}",
    },
    sms: { body: "TX: Expense {{number}} from {{employee}} {{currency}} {{amount}} pending approval." },
    inApp: { subject: "Expense pending approval", body: "{{employee}} — {{currency}} {{amount}}" },
  },
  {
    category: "expense_approved",
    email: {
      subject: "Expense {{number}} approved",
      body: "Your expense {{number}} of {{currency}} {{amount}} has been approved.\n\nReimbursement queued via {{method}}.",
    },
    sms: { body: "TX: Expense {{number}} approved — {{currency}} {{amount}} via {{method}}." },
    inApp: { subject: "Expense approved", body: "{{number}} — {{currency}} {{amount}}" },
  },
  {
    category: "expense_rejected",
    email: {
      subject: "Expense {{number}} rejected",
      body: "Your expense {{number}} was rejected.\n\nReason: {{reason}}\n\n{{href}}",
    },
    sms: { body: "TX: Expense {{number}} rejected. Reason: {{reason}}" },
    inApp: { subject: "Expense rejected", body: "{{number}} — {{reason}}" },
  },
  {
    category: "invoice_issued",
    email: {
      subject: "Invoice {{number}} issued — {{currency}} {{amount}}",
      body: "Invoice {{number}} has been issued to {{customer}}.\n\nAmount: {{currency}} {{amount}}\nDue: {{dueDate}}\n\n{{href}}",
    },
    sms: { body: "TX: Invoice {{number}} issued — {{customer}} {{currency}} {{amount}}." },
    inApp: { subject: "Invoice issued", body: "{{customer}} — {{currency}} {{amount}}" },
  },
  {
    category: "invoice_paid",
    email: {
      subject: "Invoice {{number}} paid",
      body: "Invoice {{number}} has been paid in full by {{customer}}.\n\nAmount: {{currency}} {{amount}}\nMethod: {{method}}",
    },
    sms: { body: "TX: Invoice {{number}} paid — {{customer}} {{currency}} {{amount}}." },
    inApp: { subject: "Invoice paid", body: "{{customer}} — {{currency}} {{amount}}" },
  },
  {
    category: "invoice_overdue",
    email: {
      subject: "Invoice {{number}} OVERDUE — {{daysLate}} days",
      body: "Invoice {{number}} is {{daysLate}} days past due.\n\nCustomer: {{customer}}\nAmount outstanding: {{currency}} {{amount}}",
    },
    sms: { body: "TX: Invoice {{number}} OVERDUE {{daysLate}}d — {{customer}} {{currency}} {{amount}}." },
    inApp: { subject: "Invoice overdue", body: "{{customer}} — {{daysLate}}d late" },
  },
  {
    category: "bill_received",
    email: {
      subject: "Bill {{number}} from {{supplier}}",
      body: "A new bill from {{supplier}} has been received.\n\nAmount: {{currency}} {{amount}}\nDue: {{dueDate}}\n\n{{href}}",
    },
    sms: { body: "TX: Bill {{number}} from {{supplier}} {{currency}} {{amount}}." },
    inApp: { subject: "Bill received", body: "{{supplier}} — {{currency}} {{amount}}" },
  },
  {
    category: "bill_due_soon",
    email: {
      subject: "Bill {{number}} due in {{daysToDue}} days",
      body: "Bill {{number}} from {{supplier}} is due in {{daysToDue}} days.\n\nAmount: {{currency}} {{amount}}",
    },
    sms: { body: "TX: Bill {{number}} due in {{daysToDue}}d — {{supplier}} {{currency}} {{amount}}." },
    inApp: { subject: "Bill due soon", body: "{{supplier}} — due in {{daysToDue}}d" },
  },
  {
    category: "leave_requested",
    email: {
      subject: "Leave request {{number}} from {{employee}}",
      body: "{{employee}} has requested {{leaveType}} leave from {{startDate}} to {{endDate}} ({{days}} working days).\n\nReason: {{reason}}\n\nApprove: {{href}}",
    },
    sms: { body: "TX: Leave {{number}} from {{employee}} {{startDate}}-{{endDate}} ({{days}}d) pending." },
    inApp: { subject: "Leave pending approval", body: "{{employee}} — {{leaveType}} {{days}}d" },
  },
  {
    category: "leave_approved",
    email: {
      subject: "Leave {{number}} approved",
      body: "Your {{leaveType}} leave from {{startDate}} to {{endDate}} has been approved.\n\nApprover: {{approver}}",
    },
    sms: { body: "TX: Leave {{number}} approved — {{startDate}} to {{endDate}}." },
    inApp: { subject: "Leave approved", body: "{{leaveType}} {{startDate}} → {{endDate}}" },
  },
  {
    category: "leave_rejected",
    email: {
      subject: "Leave {{number}} rejected",
      body: "Your {{leaveType}} leave request was not approved.\n\nReason: {{reason}}",
    },
    sms: { body: "TX: Leave {{number}} rejected. Reason: {{reason}}" },
    inApp: { subject: "Leave rejected", body: "{{leaveType}} — {{reason}}" },
  },
  {
    category: "payroll_period_paid",
    email: {
      subject: "Payroll {{period}} paid — KSh {{netPay}}",
      body: "Your salary for {{period}} has been processed.\n\nGross: KSh {{grossPay}}\nDeductions: KSh {{deductions}}\nNet: KSh {{netPay}}\n\nDispatched to {{bankOrMpesa}}.",
    },
    sms: { body: "TX: Salary for {{period}} KSh {{netPay}} paid via {{bankOrMpesa}}." },
    inApp: { subject: "Salary paid", body: "{{period}} — KSh {{netPay}}" },
    mandatory: true,
  },
  {
    category: "loan_disbursed",
    email: {
      subject: "Loan {{number}} disbursed",
      body: "Your loan of KSh {{principal}} has been disbursed.\n\nMonthly recovery: KSh {{monthlyRecovery}}\nTerm: {{termMonths}} months",
    },
    sms: { body: "TX: Loan {{number}} KSh {{principal}} disbursed. Monthly: {{monthlyRecovery}}." },
    inApp: { subject: "Loan disbursed", body: "KSh {{principal}} — {{termMonths}} months" },
  },
  {
    category: "compliance_expiring",
    email: {
      subject: "{{kind}} for {{employee}} expires in {{daysToExpiry}} days",
      body: "Reminder: {{employee}}'s {{kind}} expires on {{expiryDate}} ({{daysToExpiry}} days).\n\n{{href}}",
    },
    sms: { body: "TX: {{kind}} for {{employee}} expires in {{daysToExpiry}}d ({{expiryDate}})." },
    inApp: { subject: "Compliance expiring", body: "{{employee}} — {{kind}} in {{daysToExpiry}}d" },
  },
  {
    category: "compliance_expired",
    email: {
      subject: "EXPIRED: {{kind}} for {{employee}}",
      body: "{{employee}}'s {{kind}} expired on {{expiryDate}}. Please action immediately.\n\n{{href}}",
    },
    sms: { body: "TX: {{kind}} for {{employee}} EXPIRED on {{expiryDate}}." },
    inApp: { subject: "Compliance EXPIRED", body: "{{employee}} — {{kind}}" },
    mandatory: true,
  },
  {
    category: "jobcard_opened",
    email: {
      subject: "Job card {{number}} opened — {{truckPlate}}",
      body: "Job card {{number}} has been opened for truck {{truckPlate}}.\n\nFault: {{fault}}\n\n{{href}}",
    },
    sms: { body: "TX: Job card {{number}} opened {{truckPlate}}." },
    inApp: { subject: "Job card opened", body: "{{truckPlate}} — {{fault}}" },
  },
  {
    category: "jobcard_completed",
    email: {
      subject: "Job card {{number}} closed — {{truckPlate}}",
      body: "Job card {{number}} for truck {{truckPlate}} has been closed.\n\nDuration: {{duration}}\nCost: KSh {{cost}}\n\n{{href}}",
    },
    sms: { body: "TX: Job card {{number}} closed {{truckPlate}} — KSh {{cost}}." },
    inApp: { subject: "Job card completed", body: "{{truckPlate}} — KSh {{cost}}" },
  },
  {
    category: "appraisal_advanced",
    email: {
      subject: "Appraisal advanced to {{stage}} for {{employee}}",
      body: "{{employee}}'s appraisal for {{cycle}} has advanced to: {{stage}}.\n\n{{href}}",
    },
    sms: { body: "TX: Appraisal {{cycle}} {{employee}} now {{stage}}." },
    inApp: { subject: "Appraisal advanced", body: "{{employee}} — {{stage}}" },
  },
  {
    category: "digest_daily",
    email: {
      subject: "TX daily digest — {{date}}",
      body: "Today on TX:\n\n{{summary}}\n\nView the dashboard: {{href}}",
    },
...
function seedNotificationTemplates() {
  ...
  for (const seed of TEMPLATE_SEEDS) {
    const mandatory = seed.mandatory ?? false;
    notificationTemplates.set(tplId(seed.category, "email"), {
      id: tplId(seed.category, "email"),
      category: seed.category,
      channel: "email",
      subject: seed.email.subject,
      body: seed.email.body,
      mandatory,
      updatedAt: now,
    });
    notificationTemplates.set(tplId(seed.category, "sms"), {
      id: tplId(seed.category, "sms"),
      category: seed.category,
      channel: "sms",
      subject: seed.sms.body.slice(0, 60),
      body: seed.sms.body,
      mandatory,
      updatedAt: now,
    });
    notificationTemplates.set(tplId(seed.category, "in_app"), {
      id: tplId(seed.category, "in_app"),
      category: seed.category,
      channel: "in_app",
      subject: seed.inApp.subject,
      body: seed.inApp.body,
      mandatory: true, // In-app is always available; never silenced
      updatedAt: now,
    });
  }
}
...
/** Default channel preferences per category. Used when a recipient has no
 *  explicit preference yet. */
const DEFAULT_CHANNELS_BY_CATEGORY: Record<NotificationCategory, NotificationChannel[]> = {
  trip_planned:        ["in_app", "email"],
  trip_loaded:         ["in_app"],
  trip_at_border:      ["in_app", "email"],
  trip_delivered:      ["in_app", "email"],
  trip_pod_uploaded:   ["in_app"],
  expense_submitted:   ["in_app", "email"],
  expense_approved:    ["in_app", "email"],
  expense_rejected:    ["in_app", "email"],
  invoice_issued:      ["in_app", "email"],
  invoice_paid:        ["in_app", "email"],
  invoice_overdue:     ["in_app", "email", "sms"],
  bill_received:       ["in_app", "email"],
  bill_due_soon:       ["in_app", "email"],
  leave_requested:     ["in_app", "email"],
  leave_approved:      ["in_app", "email", "sms"],
  leave_rejected:      ["in_app", "email"],
  payroll_period_paid: ["in_app", "email", "sms"],
  loan_disbursed:      ["in_app", "email", "sms"],
  compliance_expiring: ["in_app", "email"],
  compliance_expired:  ["in_app", "email", "sms"],
  jobcard_opened:      ["in_app"],
...
function seedNotificationPreferences() {
  // Office staff get default preferences for every category
  const officeIds = ["emp-001", "emp-002", "emp-003", "emp-004", "emp-005", "emp-006", "emp-007"];
  const cats = Object.keys(DEFAULT_CHANNELS_BY_CATEGORY) as NotificationCategory[];
  for (const eid of officeIds) {
    for (const cat of cats) {
      const id = prefId(eid, cat);
      notificationPreferences.set(id, {
        id,
        recipientId: eid,
        category: cat,
  ...
  // Drivers: only trip + payroll + leave + compliance
  const driverEmpIds = ["emp-100", "emp-101", "emp-102", "emp-103", "emp-104", "emp-105", "emp-106"];
  const driverCats: NotificationCategory[] = [
    "trip_planned", "trip_loaded", "trip_at_border", "trip_delivered",
    "leave_approved", "leave_rejected", "payroll_period_paid",
    "compliance_expiring", "compliance_expired",
  ];
  for (const eid of driverEmpIds) {
    for (const cat of driverCats) {
      const id = prefId(eid, cat);
      notificationPreferences.set(id, {
        id,
        recipientId: eid,
        category: cat,
        // Drivers prefer SMS — no email until they have a corporate address
        channels: cat === "leave_approved" || cat === "leave_rejected" || cat === "payroll_period_paid"
          ? ["in_app", "sms"]
          : ["in_app", "sms"],
      });
    }
...
// Seed a few illustrative notifications so the UI has data on first load
function seedSampleNotifications() {
  const now = Date.now();
  const samples: Array<Omit<Notification, "id" | "createdAt">> = [
    {
      category: "leave_requested",
      channel: "in_app",
      recipientId: "emp-004",
      recipientLabel: "Faith Njeri",
      destination: "in-app:emp-004",
      subject: "Leave pending approval",
      body: "Grace Akinyi — Annual 5d",
      href: "/hr/leave",
      priority: "normal",
      status: "delivered",
    ...
    },
    {
      ...
      recipientLabel: "Faith Njeri",
      destination: "in-app:emp-004",
      subject: "Compliance EXPIRED",
      body: "Samuel Kiprotich — Diesel Mechanic Cert",
      href: "/hr/compliance",
      priority: "high",
      status: "delivered",
      sentAt: new Date(now - 26 * 60 * 60 * 1000).toISOString(),
    },
    {
      category: "compliance_expiring",
      channel: "in_app",
      ...
      recipientLabel: "Faith Njeri",
      destination: "in-app:emp-004",
      subject: "Compliance expiring",
      body: "Brian Otieno — Passport in 20d",
      href: "/hr/compliance",
      priority: "normal",
      status: "delivered",
      sentAt: new Date(now - 5 * 60 * 60 * 1000).toISOString(),
    },
    {
      category: "invoice_overdue",
      channel: "in_app",
      recipientId: "emp-002",
      recipientLabel: "Esther Wanjiru",
      destination: "in-app:emp-002",
      subject: "Invoice overdue",
      body: "Bidco Africa — 12d late",
    ...
    },
    {
      ...
      recipientId: "emp-004",
      recipientLabel: "Faith Njeri",
      destination: "faith@nilevalley.co.ke",
      subject: "Leave request REQ-2026-00001 from Grace Akinyi",
      body: "Grace Akinyi has requested Annual leave from … (truncated mock body)",
      href: "/hr/leave",
      priority: "normal",
      status: "sent",
      providerMessageId: "email-mock-aa11bb",
      sentAt: new Date(now - 3 * 60 * 60 * 1000 + 1500).toISOString(),
    },
    {
      category: "compliance_expired",
      channel: "sms",
      recipientId: "emp-004",
      recipientLabel: "Faith Njeri",
      destination: "+254 722 000 004",
      subject: "TX: Diesel Mechanic Cert for Samuel Kiprotich EXPIRED on …",
      body: "TX: Diesel Mechanic Cert for Samuel Kiprotich EXPIRED on 2026-04-25.",
      priority: "high",
      status: "delivered",
      providerMessageId: "at-mock-91cf",
      sentAt: new Date(now - 26 * 60 * 60 * 1000 + 4200).toISOString(),
    },
    {
      category: "invoice_paid",
      channel: "email",
      recipientId: "emp-002",
      recipientLabel: "Esther Wanjiru",
      destination: "esther@nilevalley.co.ke",
      subject: "Invoice INV-2026-0042 paid",
      body: "Invoice INV-2026-0042 paid in full by Unilever Kenya — KES 1,250,000.",
      priority: "normal",
      status: "sent",
      providerMessageId: "email-mock-cd22ee",
      sentAt: new Date(now - 8 * 60 * 60 * 1000).toISOString(),
    },
    {
      category: "trip_at_border",
      channel: "sms",
      recipientId: "emp-003",
      recipientLabel: "Brian Otieno",
      destination: "+254 722 000 003",
      subject: "TX: Trip TRP-2026-0117 at Malaba awaiting clearance.",
      body: "TX: Trip TRP-2026-0117 at Malaba awaiting clearance.",
      priority: "normal",
      status: "delivered",
      providerMessageId: "at-mock-77ba",
      sentAt: new Date(now - 90 * 60 * 1000).toISOString(),
    },
    {
      category: "expense_submitted",
      channel: "email",
      recipientId: "emp-003",
      recipientLabel: "Brian Otieno",
      destination: "brian@nilevalley.co.ke",
      subject: "Expense EXP-00231 submitted by Joseph Mwangi",
      body: "Joseph Mwangi submitted expense EXP-00231 for KES 4,200. Reason: Border parking, Malaba.",
      priority: "normal",
      status: "failed",
      error: "5xx from upstream — retried 3x, queued for backoff",
      sentAt: new Date(now - 70 * 60 * 1000).toISOString(),
    },
  ];
  for (const s of samples) {
    const id = `ntf-${randomUUID().slice(0, 10)}`;
    notifications.set(id, {
      ...s,
      id,
      createdAt: s.sentAt ?? new Date().toISOString(),
    });
  }
}
...
export function listNotificationTemplates(): NotificationTemplate[] {
  return [...notificationTemplates.values()].sort((a, b) => {
...
export function getNotificationTemplate(
  ...
  return notificationTemplates.get(tplId(category, channel));
}
export function updateNotificationTemplate(
  id: string,
  patch: { subject: string; body: string },
): NotificationTemplate | { error: string } {
  const existing = notificationTemplates.get(id);
  ...
  notificationTemplates.set(id, updated);
  return updated;
}

// ----- Preferences -----
export function listNotificationPreferences(recipientId: string): NotificationPreference[] {
...
export function getNotificationPreference(
  ...
  const existing = notificationPreferences.get(prefId(recipientId, category));
  if (existing) return existing;
  // Synthesize a default if no explicit preference
  return {
    id: prefId(recipientId, category),
    recipientId,
    category,
    channels: [...DEFAULT_CHANNELS_BY_CATEGORY[category]],
  };
}
export function setNotificationPreference(
  ...
  const id = prefId(recipientId, category);
  const updated: NotificationPreference = { id, recipientId, category, channels };
  notificationPreferences.set(id, updated);
  return updated;
}
...
export function listNotifications(filter?: {
  ...
  if (filter?.recipientId) list = list.filter((n) => n.recipientId === filter.recipientId);
...
export function appendNotification(input: Omit<Notification, "id" | "createdAt">): Notification {
  const id = `ntf-${randomUUID().slice(0, 10)}`;
  const n: Notification = { ...input, id, createdAt: new Date().toISOString() };
...
export function setNotificationStatus(
  ...
  const updated: Notification = {
    ...
    ...patch,
    status,
    sentAt: status === "sent" || status === "delivered" ? n.sentAt ?? new Date().toISOString() : n.sentAt,
...
export function markNotificationRead(id: string): Notification | undefined {
  return setNotificationStatus(id, "read");
}
export function unreadNotificationsForRecipient(recipientId: string): Notification[] {
  return [...notifications.values()].filter(
    (n) => n.recipientId === recipientId && n.channel === "in_app" && n.status !== "read",
  ).sort((a, b) => b.createdAt.localeCompare(a.createdAt));
}

/** Resolve email/phone for an employee. */
export function recipientAddress(
  ...
  if (!e) return undefined;
  if (channel === "email") return e.email || undefined;
  if (channel === "sms") return e.mpesaPhone;
  if (channel === "in_app") return `in-app:${employeeId}`;
  return undefined;
}

export function notificationTotals(): {
  total: number;
  sent: number;
  delivered: number;
  failed: number;
  ...
  let sent = 0, delivered = 0, failed = 0, inApp = 0, email = 0, sms = 0;
  for (const n of notifications.values()) {
    if (n.status === "sent") sent++;
    if (n.status === "delivered") delivered++;
    if (n.status === "failed" || n.status === "bounced") failed++;
    if (n.channel === "in_app") inApp++;
    if (n.channel === "email") email++;
